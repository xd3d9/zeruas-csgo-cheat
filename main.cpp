...
DWORD WINAPI main(PVOID base)
{
	...
	CreateDirectory(crypt_str("C:\\gs\\"), NULL);
	CreateDirectory(crypt_str("C:\\gs\\luas\\"), NULL);
	CreateDirectory(crypt_str("C:\\gs\\cfg\\"), NULL);
	DWORD* nFonts;
...
__forceinline void setup_render()
{
	...
	fonts[KNIFES] = create_font(crypt_str("IcoMoon-Free"), 13, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
